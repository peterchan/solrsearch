package com.alibaba.icbu.solrsearch.client;
...
import com.alibaba.icbu.solrsearch.reflect.EntityConvert;
...
public class SearchClient {
    ...
    /**
     * 提交数据采用批量提交 注意：该Map元素必须不大于1024或者去更改solrconfig.xml中的参数，参数如下： &ltmaxBooleanClauses&gt1024&lt/maxBooleanClauses&gt
     * 
    ...
    /**
     * 批量删除数据 注意：该数组元素必须不大于1024或者去更改solrconfig.xml中的参数，参数如下： &lgmaxBooleanClauses&gt1024&lg/maxBooleanClauses&gt
     * 
     * @param idArrays Id数组
     * @param idName Id名称
     * @param server
